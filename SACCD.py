...
class SUMOEnvironment:
    ...
    def start_sumo(self, port, seed):
        ...
        sumo_cmd = [sumoBinary, "-c", self.sumo_cfg, "--remote-port", str(port),
                    "--seed", str(seed), "--no-warnings"]
...
if __name__ == "__main__":
    # Example usage
    SUMO_CFG = "E:\CODING\gityoutubetest.sumocfg"  # Update with your SUMO config file
